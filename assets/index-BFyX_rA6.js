 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ye(t,e){const n={typeString:t};return e&&(n.value=e),n}function po(t,e){if(!C_(t))throw new J(M.INVALID_ARGUMENT,"JSON must be an object");let n;for(const r in e)if(e[r]){const s=e[r].typeString,i="value"in e[r]?{value:e[r].value}:void 0;if(!(r in t)){n=`JSON missing required field: '${r}'`;break}const o=t[r];if(s&&typeof o!==s){n=`JSON field '${r}' must be a ${s}.`;break}if(i!==void 0&&o!==i.value){n=`Expected '${r}' field to equal '${i.value}'`;break}}if(n)throw new J(M.INVALID_ARGUMENT,n);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class F_{}class Qe extends F_{constructor(e,n,r){super(),this.field=e,this.op=n,this.value=r}static create(e,n,r){return e.isKeyField()?n==="in"||n==="not-in"?this.createKeyFieldInFilter(e,n,r):new qR(e,n,r):n==="array-contains"?new WR(e,r):n==="in"?new KR(e,r):n==="not-in"?new GR(e,r):n==="array-contains-any"?new QR(e,r):new Qe(e,n,r)}static createKeyFieldInFilter(e,n,r){return n==="in"?new HR(e,r):new zR(e,r)}matches(e){const n=e.data.field(this.field);return this.op==="!="?n!==null&&n.nullValue===void 0&&this.matchesComparison(Ms(n,this.value)):n!==null&&wr(this.value)===wr(n)&&this.matchesComparison(Ms(n,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return ce(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class sn extends F_{constructor(e,n){super(),this.filters=e,this.op=n,this.Pe=null}static create(e,n){return new sn(e,n)}matches(e){return B_(this)?this.filters.find((n=>!n.matches(e)))===void 0:this.filters.find((n=>n.matches(e)))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce(((e,n)=>e.concat(n.getFlattenedFilters())),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function B_(t){return t.op==="and"}function $_(t){return jR(t)&&B_(t)}function jR(t){for(const e of t.filters)if(e instanceof sn)return!1;return!0}function Nl(t){if(t instanceof Qe)return t.field.canonicalString()+t.op.toString()+Ls(t.value);if($_(t))return t.filters.map((e=>Nl(e))).join(",");{const e=t.filters.map((n=>Nl(n))).join(",");return`${t.op}(${e})`}}function j_(t,e){return t instanceof Qe?(function(r,s){return s instanceof Qe&&r.op===s.op&&r.field.isEqual(s.field)&&wn(r.value,s.value)})(t,e):t instanceof sn?(function(r,s){return s instanceof sn&&r.op===s.op&&r.filters.length===s.filters.length?r.filters.reduce(((i,o,c)=>i&&j_(o,s.filters[c])),!0):!1})(t,e):void ce(19439)}function q_(t){return t instanceof Qe?(function(n){return`${n.field.canonicalString()} ${n.op} ${Ls(n.value)}`})(t):t instanceof sn?(function(n){return n.op.toString()+" {"+n.getFilters().map(q_).join(" ,")+"}"})(t):"Filter"}class qR extends Qe{constructor(e,n,r){super(e,n,r),this.key=ne.fromName(r.referenceValue)}matches(e){const n=ne.comparator(e.key,this.key);return this.matchesComparison(n)}}class HR extends Qe{constructor(e,n){super(e,"in",n),this.keys=H_("in",n)}matches(e){return this.keys.some((n=>n.isEqual(e.key)))}}class zR extends Qe{constructor(e,n){super(e,"not-in",n),this.keys=H_("not-in",n)}matches(e){return!this.keys.some((n=>n.isEqual(e.key)))}}function H_(t,e){return(e.arrayValue?.values||[]).map((n=>ne.fromName(n.referenceValue)))}class WR extends Qe{constructor(e,n){super(e,"array-contains",n)}matches(e){const n=e.data.field(this.field);return Du(n)&&eo(n.arrayValue,this.value)}}class KR extends Qe{constructor(e,n){super(e,"in",n)}matches(e){const n=e.data.field(this.field);return n!==null&&eo(this.value.arrayValue,n)}}class GR extends Qe{constructor(e,n){super(e,"not-in",n)}matches(e){if(eo(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const n=e.data.field(this.field);return n!==null&&n.nullValue===void 0&&!eo(this.value.arrayValue,n)}}class QR extends Qe{constructor(e,n){super(e,"array-contains-any",n)}matches(e){const n=e.data.field(this.field);return!(!Du(n)||!n.arrayValue.values)&&n.arrayValue.values.some((r=>eo(this.value.arrayValue,r)))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class is{constructor(e,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new is(this.firestore,e,this._query)}}class st{constructor(e,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new mr(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new st(this.firestore,e,this._key)}toJSON(){return{type:st._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,n,r){if(po(n,st._jsonSchema))return new st(e,r||null,new ne(Me.fromString(n.referencePath)))}}st._jsonSchemaVersion="firestore/documentReference/1.0",st._jsonSchema={type:Ye("string",st._jsonSchemaVersion),referencePath:Ye("string")};class mr extends is{constructor(e,n,r){super(e,n,z_(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new st(this.firestore,null,new ne(e))}withConverter(e){return new mr(this.firestore,e,this._path)}}function Dp(t,e,...n){if(t=et(t),S_("collection","path",e),t instanceof fc){const r=Me.fromString(e,...n);return Hd(r),new mr(t,null,r)}{if(!(t instanceof st||t instanceof mr))throw new J(M.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Me.fromString(e,...n));return Hd(r),new mr(t.firestore,null,r)}}function _P(t,e,...n){if(t=et(t),arguments.length===1&&(e=Pu.newId()),S_("doc","path",e),t instanceof fc){const r=Me.fromString(e,...n);return qd(r),new st(t,null,new ne(r))}{if(!(t instanceof st||t instanceof mr))throw new J(M.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Me.fromString(e,...n));return qd(r),new st(t.firestore,t instanceof mr?t.converter:null,new ne(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tn{constructor(e){this._values=(e||[]).map((n=>n))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(r,s){if(r.length!==s.length)return!1;for(let i=0;i<r.length;++i)if(r[i]!==s[i])return!1;return!0})(this._values,e._values)}toJSON(){return{type:Tn._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(po(e,Tn._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((n=>typeof n=="number")))return new Tn(e.vectorValues);throw new J(M.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Tn._jsonSchemaVersion="firestore/vectorValue/1.0",Tn._jsonSchema={type:Ye("string",Tn._jsonSchemaVersion),vectorValues:Ye("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hv="storage";function K2(t,e,n){return t=et(t),B2(t,e,n)}function G2(t){return t=et(t),$2(t)}function Q2(t,e){return t=et(t),z2(t,e)}function Y2(t=vu(),e){t=et(t);const r=Qa(t,hv).getImmediate({identifier:e}),s=kg("storage");return s&&X2(r,...s),r}function X2(t,e,n,r={}){W2(t,e,n,r)}function J2(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new dh(n,r,s,e,Zr)}function Z2(){Kr(new yr(hv,J2,"PUBLIC").setMultipleInstances(!0)),mn($p,jp,""),mn($p,jp,"esm2020")}Z2();const ek={apiKey:"AIzaSyB8uWskczwYPUG4fWBQ7XBcdHdKDM0wKVg",authDomain:"accounting-site-5c946.firebaseapp.com",projectId:"accounting-site-5c946",storageBucket:"accounting-site-5c946.firebasestorage.app",messagingSenderId:"1030715238547",appId:"1:1030715238547:web:84e73751e15b0e26e84566",measurementId:"G-7WC5XS8LJD"},ph=Mg(ek);y_(ph);const qp=yP(ph),tk=Y2(ph),nk={key:0},rk=["src"],sk={__name:"Test",setup(t){const e=Et(""),n=Et(""),r=Et(""),s=Et(null),i=Et(""),o=async()=>{if(!e.value){i.value="標題或內容不可空白";return}try{let l="";if(s.value){const u=Q2(tk,`articles/${Date.now()}_${s.value.name}`);await K2(u,s.value),l=await G2(u)}await LP(Dp(qp,"articles"),{title:e.value,subTitle:n.value,content:r.value,imageUrl:l,createdAt:FP()}),i.value="文章上傳成功！",e.value="",n.value="",r.value="",s.value=null}catch(l){i.value=l.message}},c=Et([]);return Rr(async()=>{const l=kP(Dp(qp,"articles"),NP("createdAt","desc")),u=await MP(l);c.value=u.docs.map(f=>({id:f.id,...f.data()}))}),(l,u)=>(Ae(),Se("div",null,[X("div",null,[u[3]||(u[3]=X("h2",null,"上傳文章",-1)),Is(X("input",{"onUpdate:modelValue":u[0]||(u[0]=f=>e.value=f),placeholder:"標題"},null,512),[[Ci,e.value]]),Is(X("input",{"onUpdate:modelValue":u[1]||(u[1]=f=>n.value=f),placeholder:"副標題"},null,512),[[Ci,n.value]]),Is(X("textarea",{"onUpdate:modelValue":u[2]||(u[2]=f=>r.value=f),placeholder:"內文"},null,512),[[Ci,r.value]]),X("button",{onClick:o},"發布文章"),i.value?(Ae(),Se("p",nk,Je(i.value),1)):ks("",!0)]),u[5]||(u[5]=X("br",null,null,-1)),u[6]||(u[6]=X("hr",null,null,-1)),u[7]||(u[7]=X("br",null,null,-1)),X("div",null,[u[4]||(u[4]=X("h2",null,"文章列表",-1)),(Ae(!0),Se(Tt,null,Ai(c.value,f=>(Ae(),Se("div",{key:f.id,class:"article"},[X("h3",null,Je(f.title),1),X("p",null,Je(f.subtitle),1),f.imageUrl?(Ae(),Se("img",{key:0,src:f.imageUrl,style:{"max-width":"300px"}},null,8,rk)):ks("",!0),X("p",null,Je(f.content),1),X("small",null,Je(f.createdAt?.toDate().toLocaleString()),1)]))),128))])]))}},ik={class:"login"},ok={key:0},ak={key:1},ck={class:"btn-inside"},lk={__name:"Login",setup(t){const e=y_(),n=Et(null),r=Et(""),s=Et("");Rr(()=>{rb(e,c=>{n.value=c})});const i=async()=>{if(console.log(r.value),!r.value||!s.value){alert("帳號或密碼未輸入");return}if(r.value!=="hedecpa@gmail.com"&&r.value!=="jameschunchin@gmail.com"){alert("此帳號無權限登入");return}try{await eb(e,r.value,s.value)}catch(c){c.code==="auth/invalid-credential"||c.code==="auth/wrong-password"?alert("帳號或密碼錯誤，請重新輸入"):alert("登入失敗："+c.message)}},o=async()=>{await sb(e)};return(c,l)=>{const u=ca("router-link");return Ae(),Se("div",ik,[n.value?(Ae(),Se("div",ak,[X("p",null,"目前登入中："+Je(n.value.email),1),X("div",ck,[X("button",{onClick:o,class:"btn"},"登出"),Ce(u,{to:"/test",class:"btn"},{default:$r(()=>[...l[6]||(l[6]=[Xt("前往上傳文章",-1)])]),_:1})])])):(Ae(),Se("div",ok,[l[2]||(l[2]=Xt(" 帳號：",-1)),Is(X("input",{"onUpdate:modelValue":l[0]||(l[0]=f=>r.value=f),placeholder:"請輸入帳號"},null,512),[[Ci,r.value]]),l[3]||(l[3]=X("br",null,null,-1)),l[4]||(l[4]=Xt(" 密碼：",-1)),Is(X("input",{"onUpdate:modelValue":l[1]||(l[1]=f=>s.value=f),type:"password",placeholder:"請輸入密碼"},null,512),[[Ci,s.value]]),l[5]||(l[5]=X("br",null,null,-1)),X("div",{class:"btn-inside"},[X("button",{onClick:i,class:"btn"},"登入")])]))])}}},uk=Gt(lk,[["__scopeId","data-v-0dca3547"]]),hk=[{path:"/",component:Gw},{path:"/news",component:uI},{path:"/news/:id",component:vI},{path:"/test",component:sk},{path:"/login",component:uk}],fk=pw({history:qT(),routes:hk});sT(hT).use(fk).use(tI()).mount("#app");
